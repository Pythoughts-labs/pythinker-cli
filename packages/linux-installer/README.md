...
```sh
# Debian / Ubuntu
curl -LO https://github.com/Pythoughts-labs/pythinker-code/releases/download/v0.58.0/pythinker-code_0.58.0_amd64.deb
curl -LO https://github.com/Pythoughts-labs/pythinker-code/releases/download/v0.58.0/pythinker-code_0.58.0_amd64.deb.sha256
sha256sum -c pythinker-code_0.58.0_amd64.deb.sha256
...
```sh
bash packages/linux-installer/build.sh 0.58.0
```

Outputs to `dist/`:

- `pythinker-code_0.58.0_amd64.deb`
- `pythinker-code-0.58.0.x86_64.rpm`
