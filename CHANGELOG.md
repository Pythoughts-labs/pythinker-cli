...
- Fixed reasoning summaries exposing Markdown delimiters and duplicate terminal rows after refocus, and redesigned parallel agent progress as a compact agent activity tree.
